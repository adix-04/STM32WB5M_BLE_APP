...
typedef enum
{
  ...
  /* Notify */
  CUSTOM_STM_NOTIFY_READ_EVT,
  CUSTOM_STM_NOTIFY_NOTIFY_ENABLED_EVT,
  CUSTOM_STM_NOTIFY_NOTIFY_DISABLED_EVT,
...
/* Exported constants --------------------------------------------------------*/
extern uint16_t SizeWrite;
extern uint16_t SizeNotify;
